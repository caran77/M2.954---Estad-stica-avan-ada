...
El nostre objectiu és comprovar si el nivell de felicitat (happiness) depèn del sexe de la persona. Això ho podrem validar comparant les mitjanes i variances mostrals.
...
```{r grafic densitat seniority per qualificació}
distinctQua <- c("C", "PC")
